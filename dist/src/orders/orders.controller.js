...
__decorate([
    ...
    (0, swagger_1.ApiNotFoundResponse)({ description: 'Orden no encontrada.' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar una orden existente' }),
    (0, swagger_1.ApiOkResponse)({
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Eliminar una orden por su ID' }),
    (0, swagger_1.ApiOkResponse)({
