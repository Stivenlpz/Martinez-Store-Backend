...
__decorate([
    ...
    (0, swagger_1.ApiCreatedResponse)({ type: order_item_entity_1.OrderItemEntity }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ type: [order_item_entity_1.OrderItemEntity] }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve an order item by ID' }),
    (0, swagger_1.ApiOkResponse)({ type: order_item_entity_1.OrderItemEntity }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Order item removed successfully' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
